...
void DataPkt::setFlitCount(int flitCount)
{
    this->flitCount = flitCount;
}

int DataPkt::getSrc_ppid() const
{
    return this->src_ppid;
}

void DataPkt::setSrc_ppid(int src_ppid)
{
    this->src_ppid = src_ppid;
}

int DataPkt::getDst_ppid() const
{
    return this->dst_ppid;
}

void DataPkt::setDst_ppid(int dst_ppid)
{
    this->dst_ppid = dst_ppid;
}

long DataPkt::getPackageGenTime() const
{
    return this->packageGenTime;
}

void DataPkt::setPackageGenTime(long packageGenTime)
{
    this->packageGenTime = packageGenTime;
}

bool DataPkt::getIsHead() const
{
    return this->isHead;
}

void DataPkt::setIsHead(bool isHead)
{
    this->isHead = isHead;
}

bool DataPkt::getIsTail() const
{
    return this->isTail;
}

void DataPkt::setIsTail(bool isTail)
{
    this->isTail = isTail;
}

int DataPkt::getVc_id() const
{
    return this->vc_id;
}

void DataPkt::setVc_id(int vc_id)
{
    this->vc_id = vc_id;
}

int DataPkt::getHopCount() const
{
    return this->hopCount;
}

void DataPkt::setHopCount(int hopCount)
{
    this->hopCount = hopCount;
}

int DataPkt::getFrom_router_port() const
{
    return this->from_router_port;
}

void DataPkt::setFrom_router_port(int from_router_port)
{
