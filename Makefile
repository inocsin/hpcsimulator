#
# OMNeT++/OMNEST Makefile for hpcsimulator
#
...
TARGET = hpcsimulator$(EXE_SUFFIX)
...
clean:
	$(qecho) Cleaning...
	$(Q)-rm -rf $O
	$(Q)-rm -f hpcsimulator hpcsimulator.exe libhpcsimulator.so libhpcsimulator.a libhpcsimulator.dll libhpcsimulator.dylib
...
$O/buffer_info_m.o: buffer_info_m.cc \
	buffer_info_m.h
$O/data_pkt_m.o: data_pkt_m.cc \
	data_pkt_m.h
