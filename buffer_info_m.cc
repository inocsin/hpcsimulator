...
Register_Class(BufferInfoMsg);

BufferInfoMsg::BufferInfoMsg(const char *name, int kind) : ::omnetpp::cMessage(name,kind)
{
    this->from_port = 0;
    this->vcid = 0;
...
BufferInfoMsg::~BufferInfoMsg()
{
}

BufferInfoMsg& BufferInfoMsg::operator=(const BufferInfoMsg& other)
{
...
void BufferInfoMsg::copy(const BufferInfoMsg& other)
{
...
void BufferInfoMsg::setFrom_port(int from_port)
{
...
class BufferInfoMsgDescriptor : public omnetpp::cClassDescriptor
{
  ...
  public:
    BufferInfoMsgDescriptor();
    virtual ~BufferInfoMsgDescriptor();
...
Register_ClassDescriptor(BufferInfoMsgDescriptor);

BufferInfoMsgDescriptor::BufferInfoMsgDescriptor() : omnetpp::cClassDescriptor("BufferInfoMsg", "omnetpp::cMessage")
{
    propertynames = nullptr;
}

BufferInfoMsgDescriptor::~BufferInfoMsgDescriptor()
{
    delete[] propertynames;
}

bool BufferInfoMsgDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<BufferInfoMsg *>(obj)!=nullptr;
}

const char **BufferInfoMsgDescriptor::getPropertyNames() const
{
    if (!propertynames) {
...
const char *BufferInfoMsgDescriptor::getProperty(const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *BufferInfoMsgDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *BufferInfoMsgDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int BufferInfoMsgDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    BufferInfoMsg *pp = (BufferInfoMsg *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

std::string BufferInfoMsgDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool BufferInfoMsgDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *BufferInfoMsgDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *BufferInfoMsgDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
